#
          ...
          #Final output consists of points belonging to each cluster
          #Note: The trailing (0,0) points being printed out after the points for each cluster represent null or empty slots in array
#
.data
#Centroid 1 input
